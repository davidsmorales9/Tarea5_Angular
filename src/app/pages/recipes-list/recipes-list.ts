...
@Component({
  ...
  imports: [ FormsModule, RouterLink], //agrear RouterLink si es necesario
  templateUrl: './recipes-list.html',
  styleUrl: './recipes-list.css',
})
export class RecipesList {

  //tipo de filtro seleccionado por nombre o dificultad
  filterType = "";
  //valor ingresado en el imput
  _name ="";
  //valor iniciado por el droptown
  _difficulty = "";
